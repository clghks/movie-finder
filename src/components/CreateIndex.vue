    ...
    <div class="container">
      ...
      <form>
        <div class="form-group row">
          <label for="inputIndexName" class="col-sm-2 col-form-label"
            >Index 이름</label
          >
          <div class="col-sm-10">
            <input
        ...
        <div class="form-group row">
          ...
          <div class="form-check form-check-inline">
            <input
              ...
              value="movie"
              v-model="indexName"
              @click="setKoreanSEunjeonAnalyzer"
            />
          ...
          <div class="form-check form-check-inline">
            <input
              ...
              type="radio"
              id="inlineRadio2"
              value="movie_autocomplete"
              v-model="indexName"
              @click="setKoreanJamoAnalyzer"
            />
            <label class="form-check-label" for="inlineRadio2"
              >movie_autocomplete</label
            >
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" rows="35" cols="50" id="bodyReq">{{
              reqBody
            }}</textarea>
          </div>
        </div>
        <a
          href="javascript:;"
          class="btn btn-secondary router-link-exact-active router-link-active"
